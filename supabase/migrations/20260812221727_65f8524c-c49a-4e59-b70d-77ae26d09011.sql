-- Migration: Correct mapping of columns in gravar_avaliacao_com_credito
-- Date: 2026-08-12 22:16:48
...
BEGIN
  ...
  -- Insert evaluation using correct column names:
  -- titulo -> localizacao
  ...
  INSERT INTO public.avaliacoes (
    ...
    COALESCE(p_avaliacao_data->>'tipo_relatorio', 'Estudo de Mercado Simplificado'),
  ...
  -- Insert comparables
  INSERT INTO public.comparaveis (avaliacao_id, user_id, localizacao, tipo, area, area_privativa, area_construida, quartos, suites, banheiros, vagas, padrao, conservacao, posicao, andar, idade, condominio, caracteristicas, valor_anunciado)
  SELECT 
    v_avaliacao_id, 
    v_user_id, 
    value->>'localizacao',
  ...
  -- Insert results
  INSERT INTO public.resultados (avaliacao_id, valor_minimo, valor_central, valor_maximo, valor_unitario_medio, relatorio_json, versao_metodologia)
  VALUES (
    v_avaliacao_id,
