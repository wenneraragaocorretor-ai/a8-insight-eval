      ...
      {isLoading ? (
        ...
        <form onSubmit={submit} className="space-y-6">
          ...
          <Card className="premium-card">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Building2 size={18} /> Informações Profissionais
              </CardTitle>
            </CardHeader>
            <CardContent className="grid gap-4 md:grid-cols-2">
              <div>
              ...
              <div>
                ...
                <Input
                  value={form.cnai}
                  onChange={(e) => set("cnai", e.target.value)}
              ...
              <div className="md:col-span-2">
                ...
                <Input
                  value={form.outro_registro}
                  onChange={(e) => set("outro_registro", e.target.value)}
                  placeholder="Ex: CAU A12345-0, CREA-SP 123456"
                />
              </div>
              <div>
                <Label>Tipo *</Label>
          ...
          <Card className="premium-card">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <ImageIcon size={18} /> Marca e Identidade
              </CardTitle>
            </CardHeader>
          ...
          <div className="flex items-center gap-3">
            <Button
              type="submit"
              disabled={saving}
              className="bg-brand-gold text-primary-foreground h-11 px-6"
            >
