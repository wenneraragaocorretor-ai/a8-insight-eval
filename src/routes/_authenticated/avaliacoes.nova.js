                ...
                data: {
                    imovel: {
                        ...
                        tipo_acabamento: temFichaCompleta
                            ...
                            : [],
                        numero_pavimentos: temFichaCompleta && (imovel.tipo === "Casa" || imovel.tipo === "Sobrado")
      ...
      {step === 2 && (<div className="space-y-6">
          ...
          {comparaveis.map((c, index) => (<Card key={c.id} className="premium-card">
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  <Label>Área Total (m²)</Label>
                  <Input type="number" value={c.area} onChange={(e) => updateComp(index, { area: toNum(e.target.value) })}/>
                  {Number(c.valor) > 0 && (!c.area || Number(c.area) <= 0) && (<p className="text-xs font-medium text-amber-600">
                ...
                <div className="space-y-2">
                  ...
                  <Input type="number" value={c.valor} onChange={(e) => updateComp(index, { valor: toNum(e.target.value) })}/>
                  {Number(c.valor) > 0 && Number(c.valor) < 10000 && (<p className="text-xs font-medium text-destructive">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4">
              ...
              <Button onClick={() => setStep(3)} className="bg-brand-blue" disabled={comparaveis.some((c) => !c.localizacao || !c.area || Number(c.area) <= 0 || !c.valor || Number(c.valor) < 10000)}>
                Próximo
              </Button>
            </div>
          </div>
      ...
      {step === 3 && (<Card className="premium-card text-center py-12">
          <CardContent className="space-y-6">
            ...
            <div className="flex flex-col gap-4 max-w-sm mx-auto">
              <Button onClick={handleProcessar} className={isEdit ? "bg-[#0F2D5C] text-white h-12 text-lg font-bold gap-2 hover:bg-[#0A1F44]" : "bg-brand-gold text-primary-foreground h-12 text-lg font-bold"} disabled={isLoading}>
